...
namespace audioP
{
    public class Music
    {
        ...
        {
            { 32.70, "C" }, { 34.65, "Db" }, { 36.71, "D" }, { 38.89, "Eb" },
            { 41.20, "E" }, { 43.65, "F" }, { 46.25, "Gb" }, { 49.00, "G" },
            { 51.91, "Ab" }, { 55.00, "A" }, { 58.27, "Bb" }, { 61.74, "B" }
        };
        ...
        public string GetNote(double freq)
        {
            ...
            {
                double fundChange = fundFreq + ((fundFreq / 100) * percentChange);
                double fundLow = fundChange - (fundFreq / 100 * Tolerance);
                double fundHigh = fundChange + (fundFreq / 100 * Tolerance);
        ...
        public void CountNote(string noteName)
        {
            ...
            switch (note)
            {
                case "C": NoteOccurences[0]++; break;
                case "Db": NoteOccurences[1]++; break;
                case "D": NoteOccurences[2]++; break;
                case "Eb": NoteOccurences[3]++; break;
                case "E": NoteOccurences[4]++; break;
                case "F": NoteOccurences[5]++; break;
                case "Gb": NoteOccurences[6]++; break;
                case "G": NoteOccurences[7]++; break;
                case "Ab": NoteOccurences[8]++; break;
                case "A": NoteOccurences[9]++; break;
                case "Bb": NoteOccurences[10]++; break;
                case "B": NoteOccurences[11]++; break;
            }
        }
        ...
        private static string AddRemainingNotes(List<int> intervals)
        {
            ...
            for (int i = 0; i < intervals.Count; i++)
            {
                switch (intervals[i])
                {
                    case 1: remainder += "b9"; break;
                    case 2: remainder += "9"; break;
                    case 3: remainder += "#9"; break;
                    case 4: remainder += "b11"; break;
                    case 5: remainder += "11"; break;
                    case 6: remainder += "#11"; break;
                    case 8: remainder += "#5"; break;
                    case 9: remainder += "6"; break;
                    case 10: remainder += "m7"; break;
                    case 11: remainder += "maj7"; break;
                }
